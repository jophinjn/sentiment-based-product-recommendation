...
class SentimentRecommender:
    root_model_path = "pickle/"
    sentiment_model = "sentiment-classification-logistic-regression-model.pkl"
    tfidf_vectorizer = "tfidf-vectorizer.pkl"
    best_recommender = "user-final-rating.pkl"
    clean_dataframe = "cleaned-data.pkl"
